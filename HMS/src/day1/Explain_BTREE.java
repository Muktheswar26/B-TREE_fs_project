...
public class Explain_BTREE {
				...
				// Check if present
				  ...
				  private void Remove(Node x, int key , long poso) {
					    int pos = x.Find(key);
					    if (pos != -1) {
					      if (x.leaf) {
					        int i = 0;
				  ...
				  public static void main(String[] args) {
				    Explain_BTREE b = new Explain_BTREE(3);
				    b.Insert(8,108);
				    b.Show();
				    System.out.print("\n");
				    b.Insert(5,105);
				    ...
				    System.out.print("\n------------————————————-------------\n");
				    b.Show();
				    long pos = b.Contain(9);
				    if(pos!=-1234) {
				    	b.Remove(b.root,9,pos);
				    }
				    System.out.print("\n------------————————————-------------\n");
				    b.Show();
