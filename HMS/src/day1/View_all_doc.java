...
public class View_all_doc extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					View_all_doc frame = new View_all_doc();
	...
	public View_all_doc() {
        ...
        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
	        ...
	        btnNewButton_1.addActionListener(new ActionListener() {
	        	public void actionPerformed(ActionEvent e) {
	        		dispose();
	        		View_all_doc vad = new View_all_doc();
	        		vad.setVisible(true);
	        ...
	        try {
	    		...
	    		String[][] data = text_main.view_all_dr();
	    		 int num_row = text_main.rec_nums;
